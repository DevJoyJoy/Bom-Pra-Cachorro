            ...
            w-full h-full overflow-y-scroll">
                ...
                w-[90vw] h-[15vh]">
                    ...
                    <div className="flex gap-1 ml-auto self-start p-2">
                        <div className="bg-[#868585] text-white flex items-center justify-center p-3 rounded-[30%]
                        w-[5vw] h-[4vh]
                        md:h-[6vh]
                        lg:w-[3vw]">!</div>
                        <div className="bg-[#972222] text-white flex items-center justify-center p-3 rounded-[30%]
                        w-[5vw] h-[4vh]
                        md:h-[6vh]
                        lg:w-[3vw]">X</div>
                    </div>
